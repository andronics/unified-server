...
import type { PasswordService } from '@domain/auth/password-service';
import type { JwtService } from '@domain/auth/jwt-service';
...
import { UserCreatedEvent, UserUpdatedEvent, UserDeletedEvent } from '@shared/types/event-types';
